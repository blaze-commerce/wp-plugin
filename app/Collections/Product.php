			...
			$this->create_collection(
				array(
					...
					'fields' => array(
						...
						['name' => 'regularPrice.AUD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'regularPrice.NZD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'regularPrice.USD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'regularPrice.GBP', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'regularPrice.CAD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'regularPrice.EUR', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'salePrice', 'type' => 'object'],
						['name' => 'salePrice.AUD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'salePrice.NZD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'salePrice.USD', 'type' => 'float', 'optional' => true , 'facet' => true],
						['name' => 'salePrice.GBP', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'salePrice.CAD', 'type' => 'float', 'optional' => true, 'facet' => true ],
						['name' => 'salePrice.EUR', 'type' => 'float', 'optional' => true, 'facet' => true ],
